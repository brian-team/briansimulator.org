...
# BASE_URL = "https://briansimulator.org/"
...
REDIRECTIONS = [
  ['download/index.html', '/install/'],
  ['learn/index.html', '/getting-started/'],
  ['features/index.html', '/'],
  ['join-the-project/index.html', '/contribute/'],
  ['demo/index.html', 'https://brian2.readthedocs.org/en/stable/examples/'],
  ['docs/index.html', 'https://brian.readthedocs.org'],
#  ['faq/index.html', '/pages/faq.html'],
#  ['electrophysiology/index.html', '/pages/electrophysiology.html'],
  ['logo/index.html', 'https://github.com/brian-team/brian-material/tree/master/logos'],
...
MARKDOWN_EXTENSIONS = ['markdown.extensions.fenced_code', 'markdown.extensions.codehilite',
                       'markdown.extensions.extra', 'admonition', 'smarty']
